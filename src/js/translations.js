    ...
    en: {
        ...
        admin: {
            ...
            books: {
                titleEn: "Title (EN)",
                authorEn: "Author (EN)",
                translatorEn: "Translator (Optional)",
                descEn: "Description",
                btnTextEn: "Button Text",
                titleFa: "Title (FA)",
                authorFa: "Author (FA)",
                translatorFa: "Translator (FA)",
                descFa: "Description (FA)",
                btnTextFa: "Button Text (FA)",
                image: "Image URL",
                link: "Link",
                featured: "Featured",
                category: "Category",
    ...
    fa: {
        ...
        admin: {
            ...
            dashboard: {
                ...
                manageHero: "مدیریت بخش خانه",
                manageHeroDesc: "بروزرسانی متن اصلی و دکمه‌ها.",
                editHeroBtn: "ویرایش خانه",
                logout: "خروج",
            ...
            books: {
                ...
                translatorEn: "مترجم (اختیاری)",
                descEn: "توضیحات (انگلیسی)",
                btnTextEn: "متن دکمه (انگلیسی)",
                titleFa: "عنوان (فارسی)",
                authorFa: "نویسنده (فارسی)",
                translatorFa: "مترجم (فارسی)",
                descFa: "توضیحات (فارسی)",
                btnTextFa: "متن دکمه (فارسی)",
                image: "آدرس تصویر",
                link: "لینک",
                featured: "ویژه",
                category: "دسته‌بندی",
